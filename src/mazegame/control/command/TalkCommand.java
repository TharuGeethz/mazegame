...
public class TalkCommand implements Command {
    ...
    private static final List<String> FRIENDLY_PLAYER_FOLLOWUPS = Arrays.asList(
            ...
            "Good—lead on, and I’ll watch our flank."
    );
    ...
    // ----- Hostile phrase banks -----
    private static final List<String> HOSTILE_PLAYER_OPENERS = Arrays.asList(
            "I’ve come for the banner. Stand aside.",
            "You bar my path. Move or be moved.",
            "Enough lurking in shadows. Face me.",
    ...
    public CommandResponse execute(ParsedInput userInput, Player currentPlayer) {
        ...
        if (userInput.getArguments().isEmpty()) {
            return new CommandResponse("Please specify with which NPC you want to talk to.");
        }
    ...
    private CommandResponse startHostileConversation(Player player, NonPlayerCharacter npc) {
        printDialogueLine(player.getName(), ": " + pick(HOSTILE_PLAYER_OPENERS));
        sleepFor(350);
